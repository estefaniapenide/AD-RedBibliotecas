...
public class ControlData {
    ...
    public static String leerCodigo(Scanner sc) {
       ...
       public static String leerFecha(Scanner sc) {
        ...
        do {
            ...
            if (mat.matches()) {
                dia = Integer.parseInt(Character.toString(fecha.charAt(8)) + Character.toString(fecha.charAt(9)));
                mes = Integer.parseInt(Character.toString(fecha.charAt(5)) + Character.toString(fecha.charAt(6)));
                ano = Integer.parseInt(Character.toString(fecha.charAt(0)) + Character.toString(fecha.charAt(1)) + Character.toString(fecha.charAt(2)) + Character.toString(fecha.charAt(3)));
                if (mes > 12 || mes < 1) {
                    fechaValida = false;
     ...
     */
    public static String leerFechaTrucada(Scanner sc) {
        ...
        do {
            ...
            Matcher mat = pat.matcher(fecha);
            if (mat.matches()) {
                dia = (Integer.parseInt(Character.toString(fecha.charAt(8)) + Character.toString(fecha.charAt(9))))+1;
                mes = Integer.parseInt(Character.toString(fecha.charAt(5)) + Character.toString(fecha.charAt(6)));
                ano = Integer.parseInt(Character.toString(fecha.charAt(0)) + Character.toString(fecha.charAt(1)) + Character.toString(fecha.charAt(2)) + Character.toString(fecha.charAt(3)));
                if (mes > 12 || mes < 1) {
                    fechaValida = false;
    ...
    public static String leerHora(Scanner sc) {
        ...
        do {
            ...
            Matcher mat = pat.matcher(tiempo);
            if (mat.matches()) {
                int segundo = Integer.parseInt(Character.toString(tiempo.charAt(6)) + Character.toString(tiempo.charAt(7)));
                int minuto = Integer.parseInt(Character.toString(tiempo.charAt(3)) + Character.toString(tiempo.charAt(4)));
                int hora = Integer.parseInt(Character.toString(tiempo.charAt(0)) + Character.toString(tiempo.charAt(1)));
            ...
            if (!horaValida) {
                System.out.println("ERROR. No ha introducido una hora válida.\nEscriba otra fecha. Formato: hh:mm:ss");
                sc.nextLine();
            }
